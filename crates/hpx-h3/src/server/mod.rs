...
//! where
//!     C: hpx_h3::quic::Connection<bytes::Bytes> + 'static,
//!     <C as hpx_h3::quic::OpenStreams<bytes::Bytes>>::BidiStream: Send + 'static,
//! {
//!     let mut server_builder = hpx_h3::server::builder();
