...
```toml
[dependencies]
hpx = { version = "2.0.0", features = ["ws-fastwebsockets"] }
```
...
```toml
hpx = "2.0.0"  # default: boring + http1 + http2
```

**JSON API client:**

```toml
hpx = { version = "2.0.0", features = ["json", "cookies", "gzip"] }
```

**WebSocket client:**

```toml
hpx = { version = "2.0.0", features = ["ws"] }
```

**High-performance trading:**

```toml
hpx = { version = "2.0.0", features = ["simd-json", "hickory-dns", "zstd", "ws"] }
```

**Pure Rust (no C dependencies):**

```toml
hpx = { version = "2.0.0", default-features = false, features = ["rustls-tls", "http1", "http2"] }
```

**Full-featured:**

```toml
hpx = { version = "2.0.0", features = [
