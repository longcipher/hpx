...
|-------|---------|-------------|
| [`hpx`](https://crates.io/crates/hpx) | 1.3.0 | High Performance HTTP Client |
| [`hpx-util`](https://crates.io/crates/hpx-util) | 1.3.0 | Browser emulation profiles & Tower middleware |
| [`hpx-transport`](https://crates.io/crates/hpx-transport) | 1.3.0 | Exchange SDK toolkit (auth, WebSocket, rate limiting) |
| [`hpx-yawc`](https://crates.io/crates/hpx-yawc) | 1.3.0 | WebSocket library (RFC 6455 + compression) |
| [`hpx-fastwebsockets`](https://crates.io/crates/hpx-fastwebsockets) | 1.3.0 | Fast minimal WebSocket implementation |
